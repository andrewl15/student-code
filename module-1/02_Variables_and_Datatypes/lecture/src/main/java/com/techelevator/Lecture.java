...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		int numberOfMouseButtons = 6;
		System.out.println(numberOfMouseButtons);
		/*
		9. Create and set a variable that holds the percentage of battery left on
		your phone.
		*/
		String percentageOfBattery = "95%";
		System.out.println(percentageOfBattery);
		/*
		10. Create an int variable that holds the difference between 121 and 27.
		*/
		int numberOfDifference = 121 - 27;
		System.out.println(numberOfDifference);
		/*
		...
		*/
		String myFullName = "Andrew Long";
		System.out.println(myFullName);
		/*
		13. Create a String that holds the word "Hello, " concatenated onto your
		name from above.
		*/
		String concatHello = "Hello " + myFullName;
		...
		*/
		String strAddNum = "Saw" + 2;
		System.out.println(strAddNum);
		/*
		17. Add a 0 onto the end of the variable from exercise 16.
		*/
		System.out.println(strAddNum + 0);
		/*
