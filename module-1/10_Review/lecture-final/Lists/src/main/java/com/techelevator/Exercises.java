...
public class Exercises {
	...
	** INTERVIEW QUESTION **
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		...
		// figure out which list is shorter and which is longer
		List<Integer> shorterList = listOne.size() < listTwo.size() ? listOne : listTwo;
	...
	public List<Integer> interleaveListsBeforeRefactor(List<Integer> listOne, List<Integer> listTwo) {
		...
		if(listOne.size() == listTwo.size()){
			...
			// loop through the numbers for the shorter list
			for(int i = 0; i < listOne.size(); i++){
				output.add(listOne.get(i));
				output.add(listTwo.get(i));
			}
			// handled the extra values
