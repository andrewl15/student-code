...
//    }
    ...
    public static String checkDefaultConstructor(Class<?> classType) {
        Constructor defaultConstructor = SafeReflection.getConstructor(classType);
        if (defaultConstructor == null) {
            return classType.getSimpleName() + " must have a default constructor.";
        }
        return "";
    }
}
