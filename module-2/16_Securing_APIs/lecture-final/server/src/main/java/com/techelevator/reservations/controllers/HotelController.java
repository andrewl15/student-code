...
public class HotelController {
     ...
     */
     // only allows requests without a JWT
     //@PreAuthorize("isAnonymous()")
     // This allows all -- authenticated and anonymous alike
    ...
    public Reservation addReservation(@Valid @RequestBody Reservation reservation,Principal principal) {
        auditLog("Create",reservation.getId(),principal.getName());
    ...
    public void delete(@PathVariable int id, Principal principal) {
        auditLog("Delete Reservation",id,principal.getName());
